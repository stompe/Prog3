...
void GameEngine::run()
{
	...
	while(!quit)
	{
		...
		// calculate all updates in the game
		update();

		// draw everything to the screen
		draw();

		// time the frame ended
		frame_end = SDL_GetTicks();


		// delay the next frame to match desired frame rate
		...
		// quit program when no more events are generated by SDL
